...
def parse_args():
    ...
    parser.add_argument('--env_memory_filter', type=float, default=0.0)
    ...
    parser.add_argument('--env_memory_dropout', type=float, default=0.0)
    ...
    parser.add_argument('--his_memory_threshold', type=float, default=0.6)
    parser.add_argument('--his_memory_gamma', type=float, default=0.8)
