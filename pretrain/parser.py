...
def load_parser():
    ...
    parser.add_argument(
        "--model_config", type=str, help="path to model structure config json", default="config/r2r_model_config.json"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--output_dir",
        default='../datasets/R2R/exprs_map/pretrain/cmt-vitbase-mlm.mrc.sr-init.lxmert-aug.speaker',
        type=str,
    ...
    parser.add_argument(
        "--dropout", default=0.3, type=float, help="tune dropout regularization"
    )
    parser.add_argument(
        "--weight_decay",
        default=0.01,
    ...
    parser.add_argument("--config", default='pretrain/config/r2r_rssm_pretrain.json', help="JSON config files")
